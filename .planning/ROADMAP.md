...
- [x] 17-04-PLAN.md — Captive portal DNS hijack for SoftAP (DNS server on port 53, probe URL handling) — hw verify deferred to end of milestone
...
| 18. Telemetry and OTA Validation | 1/3 | In Progress|  | - |
